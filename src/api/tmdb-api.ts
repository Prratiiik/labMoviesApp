...
export const getUpcomingMovies = () => {
  ...
  // export const getMovieCast = async (id: string | number) => {
  //   try {
  //     const response = await fetch(`https://api.themoviedb.org/3/movie/${id}/credits?api_key=${import.meta.env.VITE_TMDB_KEY}`);
  //     if (!response.ok) {
